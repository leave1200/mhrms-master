                                ...
                                <div class="modal-content ">
                                    ...
                                    <div class="modal-body">
                                            ...
                                            <div class="form-group">
                                                ...
                                                <input type="text" name="loanno" class="form-control" id="recipient-name1"  required>
                                            </div>
                                            <div class="form-group">
                                            ...
                                            <div class="form-group">
                                                ...
                                                <input type="text" name="installno" class="form-control" id="recipient-name1"  required>
                                            </div>
                                            <div class="form-group">
