                            ...
                            <div class="card-body">
                                ...
                                <form class="row" method="post" action="Save" enctype="multipart/form-data">
                                    ...
                                    <div class="form-group col-md-3 m-t-20">
                                        ...
                                        <input type="text" name="eid" class="form-control form-control-line" placeholder="Example: 8820" required oninput="this.value = this.value.replace(/[^0-9]/g, '')" minlength="4" maxlength="4"> 
                                    </div>
                                    <div class="form-group col-md-3 m-t-20">
                                    ...
                                    <div class="form-group col-md-3 m-t-20">
                                        ...
                                        <input type="text" name="nid" class="form-control" value="" placeholder="0000-0000-0000" pattern="[0-9]{4}-[0-9]{4}-[0-9]{4}" required oninput="formatInput(this)">                                    </div>
                                    <div class="form-group col-md-3 m-t-20">
                                        <label>Contact Number </label>
                                        <input type="text" name="contact" class="form-control" value="" placeholder="1234567890" minlength="11" maxlength="11" required oninput="this.value = this.value.replace(/[^0-9]/g, '')"> 
                                    </div>
                                    <div class="form-group col-md-3 m-t-20">
                                    ...
                                    <div class="form-group col-md-3 m-t-20">
                                        <label>Image </label>
                                        <input type="file" name="image_url" class="form-control" value="" accept="image/*"> 
                                    </div>
